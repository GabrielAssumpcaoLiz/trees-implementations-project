...
public class TreeTests {
	...
	public void arvoreVazia() {
		...
		assertEquals("arvore vazia com tamanho 0", 0, tree.size());
	}	
	...
	public void arvoreComRoot() {
		...
		assertEquals("arvore com tamanho 1",1,tree.size());
	...
	public void rootComFilhos() {
		...
		assertEquals("arvore com tamanho 2",2,tree.size());
	...
	public void noInterno() {
		...
		assertEquals("N�o nao deve ser interno",false,tree.isInternal(child));
